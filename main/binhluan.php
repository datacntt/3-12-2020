...
<body>
    ...
    <div class='headerbinhluan'><img style='height:80px;width:80px; float:left;' src='images/iconbinhluan.png'>
        <h1 style='color:black; margin-left:20px;'>Bình luận</h1>
    </div>
    <div class="binhluan">
        <div class="comment-form-container">
            <form id="frm-comment" method='post'>
                ...
                <div class="input-row">
                    ...
                    <input class="input-field" type="text" name="comment" id="comment" placeholder="Add a Comment" style="height:80px; border-radius: 5px;" />
                    <input type="hidden" name="idtl" id="idtl" placeholder="Tailieu" value="<?php echo $_GET['idtl']; ?>" />
                </div>
                <div class="nut">
                    <input type="submit" class="btn-submit" id="submitButton" value="Đăng" style="background:grey;" name='binhluan' />
                </div>
